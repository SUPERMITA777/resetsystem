...
import { CalendarDays, User as UserIcon, Users, LayoutDashboard, Settings, Sparkles, Activity, FileBarChart, Globe, ExternalLink, ShoppingBag, Gift, Dumbbell, LogOut, QrCode, Bot, MessageSquare, Smartphone } from "lucide-react";
